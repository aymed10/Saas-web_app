              ...
              <div className="col-lg-4 mt_md--30 mt_sm--30">
                <div className="rainbow-address">
                  ...
                  <div className="inner">
                    ...
                    <p className="b2">
                    5 Chem. de Bellevue <br /> 74940 Annecy.
                    </p>
                  </div>
                </div>
                <div className="rainbow-address">
                  ...
                  <div className="inner">
                    ...
                    <p className="b2">
                      <Link href="#">+33 555 666 777</Link>
                    </p>
                    <p className="b2">
                      <Link href="#">+33 223 422 333</Link>
                    </p>
                  </div>
                </div>
                <div className="rainbow-address">
                  ...
                  <div className="inner">
                    <h4 className="title">Notre adresse e-mail</h4>
                    <p className="b2">
                      <Link href="mailto:admin@gmail.com">inge.feminin.polytech.ac@gmail.com</Link>
                    </p>
                    <p className="b2">
